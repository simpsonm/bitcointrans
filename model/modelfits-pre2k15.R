...
res <- dbSendQuery(con, "select branch, height, time, size, transactions_count from blocks where branch = 0 and height <= 385000 order by height desc limit 5011")
...
save(blockdata, file = "blockdata-pre2015.RData")

load("blockdata-pre2015.RData")
...
save(fit2, file="loggammafit-pre2k15.RData")
load("loggammafit-pre2k15.RData") 
